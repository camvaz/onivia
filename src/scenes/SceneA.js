class SceneA extends Phaser.Scene{
    constructor(){
        ...
        create() {
            ...
            const eventosA2 = Phaser.Input.Events;
            ...
            this.facil.on(eventosA2.POINTER_MOVE, (evento) => {
                this.facil.setScale(0.17);
                this.sonBotonesA.play();
                });

            this.facil.on(eventosA2.POINTER_OUT, (evento) => {
                    this.facil.setScale(0.2);
                });

            
            this.medio.on(eventosA2.POINTER_MOVE, (evento) => {
                this.medio.setScale(0.17);
                this.sonBotonesA.play();
                });

            this.medio.on(eventosA2.POINTER_OUT, (evento) => {
                    this.medio.setScale(0.2);
                });
            
            
            this.dificil.on(eventosA2.POINTER_MOVE, (evento) => {
                this.dificil.setScale(0.17);
                this.sonBotonesA.play();
                });

            this.dificil.on(eventosA2.POINTER_OUT, (evento) => {
                    this.dificil.setScale(0.2);
                });

            this.input.on(eventosA2.GAMEOBJECT_DOWN, (pointer, GameObject) =>{
