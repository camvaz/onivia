...
import SceneG from "./scenes/SceneG.js"
...
const config = {
    ...
    width: 900,			            //Ancho de pantalla del juego
    height: 570, 			        //Alto de pantalla del juego
    ...
    scene: [Bootloader,SceneA, SceneB, SceneC,SceneF,SceneG,SceneGO],    //Aquí irá la lista de scenas del juego
    banner:{
        hidePhaser: true,
        text: "#fff00f",
        background: [
